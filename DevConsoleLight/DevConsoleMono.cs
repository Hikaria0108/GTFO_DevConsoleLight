...
namespace Hikaria.DevConsoleLight
{
    internal sealed class DevConsoleMono : MonoBehaviour
    {
        ...
        private const InputKey DefaultToggleKey = InputKey.BackQuote;
        ...
        private const string InputSystemPrefabPath = "ASSETS/UNITY-DEVELOPERCONSOLE/RESOURCES/PREFABS/FAB_DEVCONSOLE.OLDEVENTSYSTEM.PREFAB";

        #endregion

        #region File data constants

        private const string PrefConsoleToggleKey = "DevConsole.legacyConsoleToggleKey";
        private const string PrefBindings = "DevConsole.legacyBindings";
        ...
        internal void EnableConsole()
        {
            ...
            Application.add_logMessageReceivedThreaded((Application.LogCallback)OnLogMessageReceived);
            ClearConsole();
        ...
        internal void DisableConsole()
        {
            ...
            ClearConsole();
            Application.remove_logMessageReceived((Application.LogCallback)OnLogMessageReceived);
        ...
        internal void OpenConsole()
        {
            ...
            {
                EventSystem.current = GameObject.Instantiate(DevConsole.s_AssetLookup[InputSystemPrefabPath].Cast<GameObject>()).GetComponent<EventSystem>();
                EventSystem.current.gameObject.name = "EventSystem";
            }
        ...
        internal static CursorLockMode lastLockMode;
        ...
        internal void OnInputValueChanged(string _)
        {
            ...
            if (_inputField.text.Length != 0 && !GetKeyDown(KeyCode.UpArrow))
            {
                OnValidateInput();
            }
        }
        ...
        internal void OnValidateInput()
        {
            const char EmptyChar = '\0';
            if (InputText.Length != 0 && ConsoleToggleKey.HasValue && GetKeyDown(ConsoleToggleKey.Value))
            {
        ...
        private void Awake()
        {
            ...
            List<Text> texts = transform.GetComponentsInChildren<Text>().ToList();
            ...
            List<InputField> inputFields = transform.GetComponentsInChildren<InputField>().ToList();
            ...
            List<RectTransform> rectTransforms1 = transform.GetComponentsInChildren<RectTransform>().ToList();
            foreach (RectTransform rectTransform in rectTransforms1)
            {
            ...
            List<Button> buttons = transform.GetComponentsInChildren<Button>().ToList();
            ...
            _decreaseTextSizeButton.onClick.AddListener(new Action(OnDecreaseTextSizeButtonPressed));
            _resizeButtonHoverColour = Color.white;
        ...
        private void Update()
        {
            ...
            if (_scrollToBottomNextFrame)
            {
                ...
                LayoutRebuilder.ForceRebuildLayoutImmediate(_logScrollView.transform.GetComponent<RectTransform>());
