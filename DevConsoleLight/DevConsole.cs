            ...
            if (!isInit)
            {
                ...
                foreach (string text in array)
                {
                    ...
                    if (@object != null)
                    {
                        ...
                        s_AssetLookup.Add(name, @object);
                    }
                }
                _console = GameObject.Instantiate(s_AssetLookup["ASSETS/UNITY-DEVELOPERCONSOLE/RESOURCES/PREFABS/FAB_DEVCONSOLE.INSTANCE.PREFAB"].Cast<GameObject>()).AddComponent<DevConsoleMono>();
            }
        }

        internal static Dictionary<string, Object> s_AssetLookup = new Dictionary<string, Object>();
